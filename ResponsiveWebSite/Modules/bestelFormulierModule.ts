...
app.service('ProductenService', qnh.Services.ProductenService);
app.controller('NavigationController', ['NavigationService', '$location', qnh.Controllers.NavigationController]);
app.controller('BestelFormulierController', ['ProductenService', 'MandjeService', '$location', qnh.Controllers.BestelformulierController]);
...
app.config([
    '$routeProvider', '$locationProvider', function ($routeProvider, $locationProvider) {
        ...
        $routeProvider.when('/', {
            ...
            .when('/step01', {templateUrl: 'partial-views/step01.html',controller: mainController})
            .when('/step02', {templateUrl: 'partial-views/step02.html',controller: mainController})
